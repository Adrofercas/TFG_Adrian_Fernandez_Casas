...
int main(int argc, const char **argv)
{
  ...
  try {
    ...
    config.enable_stream(RS2_STREAM_DEPTH); //RS2_FORMAT_RGBA8 , 640, 480, RS2_FORMAT_Z16
    g.open(config);
    g.acquire(I);
    ...
    cam = g.getCameraParameters(RS2_STREAM_DEPTH, vpCameraParameters::perspectiveProjWithDistortion);
